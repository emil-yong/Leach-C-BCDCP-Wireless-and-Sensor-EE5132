...
EDA=50*0.000000001; %Align with Leach C and BCDCP paper
...
energycontainer(v)=AggPacketRecvEnergy(2000);%/(n*Eo);
...
container_for_plot(v).third = (100*ones(1,rmax)-DEAD);%alive
